...
with st.expander("❓ Come scaricare i file JSON da Instagram"):
    ...
    2. Tocca il menu in alto a destra (le tre linee) e vai su **Centro gestione account**.
    3. Scorri fino a trovare **Le tue informazioni e autorizzazioni**.
    4. Tocca **Esporta le tue informazioni** e poi **Crea esportazione** e seleziona il tuo profilo Instagram.
    5. Tocca **Esporta sul dispositivo**.
    6. Vai su **Ricevi una notifica** e inserisci la mail.
    7. Vai su **Personalizza informazioni**, seleziona in **Contatti** la voce **Follower e persone/Pagine seguite** e salva.
    8. Vai su **Intervallo di date**, seleziona **Sempre** e salva.
    9. Vai su **Formato**, seleziona **JSON** e salva.
    10. A questo punto tocca *Avvia esportazione*.
